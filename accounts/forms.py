...
class SchoolInfoForm(forms.ModelForm):
    ...
    education_system = forms.ChoiceField(choices=[('national', 'National Curriculum'), ('international', 'International Curriculum')], widget=forms.Select(attrs={'class': 'form-control'}))
    grade = forms.ChoiceField(choices=[('grade_1', 'Grade 1'), ('grade_2', 'Grade 2'), ('grade_3', 'Grade 3')], widget=forms.Select(attrs={'class': 'form-control'}))

    class Meta:
        model = Profile
        fields = ['country', 'education_system', 'grade']
